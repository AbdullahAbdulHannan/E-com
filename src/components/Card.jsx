...
import Details from '../pages/Details'
 ...
 const Card = ({title,description, image,rating,price,productkey,productId}) => {
  ...
  return (
    <>
    <div className="max-w-2xl mx-auto" key={productkey}>


<div className="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700 mb-5">
  <a href="#">
    ...
    <div className="px-5 pb-5">
      ...
      {/* <div className="flex items-center justify-between"> */}
        ...
        <button 
          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mx-[30%] mt-10 mb-5" onClick={handleDetailsClick}>View Details</button>
      </Link>
      {/* </div> */}
    </div>
</div>
